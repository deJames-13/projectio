  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 max-w-[65%]">
        {/* Breadcrumb Trail: @handle > Workspace > Project > Tasks > Task */}
        ...
        <button
          ...
          className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors font-semibold text-slate-700 dark:text-slate-300 truncate max-w-[100px] focus:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 rounded px-1"
        ...
        <button
          ...
          className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors font-semibold text-slate-700 dark:text-slate-300 truncate max-w-[130px] focus:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 rounded px-1"
        ...
        {currentProject && (
          <>
            ...
            <button
              ...
              className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors font-semibold text-slate-700 dark:text-slate-300 truncate max-w-[140px] focus:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 rounded px-1"
        ...
        <button
          ...
          className={`transition-colors font-semibold truncate max-w-[120px] focus:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 rounded px-1 ${
            selectedTask 
              ? 'text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer' 
        ...
        {selectedTask && (
          <>
            <ChevronRight className="w-3 h-3 text-slate-400 dark:text-slate-500 shrink-0" />
            <span 
              className="text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/60 border border-blue-100 dark:border-blue-900/40 rounded px-1.5 py-0.5 font-bold truncate max-w-[160px]"
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="relative">
          <button
            ...
            className="w-8 h-8 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-center text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-colors relative cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          ...
          {showNotifications && (
            <div 
              ...
              className="absolute right-0 mt-2 w-80 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 p-3 z-50 animate-in fade-in zoom-in-95 duration-150"
            >
              <div className="flex items-center justify-between pb-2.5 border-b border-slate-100 dark:border-slate-800 px-1">
                ...
                <span className="text-[11px] font-medium text-slate-500 dark:text-slate-400">{unreadNotifications.length} unread</span>
              </div>
              <div className="divide-y divide-slate-100 dark:divide-slate-800 max-h-72 overflow-y-auto custom-scrollbar mt-1">
                  ...
                  notifications.map(n => (
                    <div 
                      ...
                      className={`p-2 rounded-lg cursor-pointer transition-colors flex items-start gap-2.5 my-0.5 ${
                        !n.read 
                          ? 'bg-blue-50/60 hover:bg-blue-50 dark:bg-blue-950/40 dark:hover:bg-blue-900/40' 
                    ...
                    >
                      ...
                      {!n.read && (
                        <button 
                          ...
                          className="p-1 hover:bg-white dark:hover:bg-slate-800 rounded text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"
                          title="Mark as read"
                        >
